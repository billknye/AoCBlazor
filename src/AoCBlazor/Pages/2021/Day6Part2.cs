...
[Route("/2021/Day6/Part2")]
public class Day6Part2 : ConsoleComponentBase
{
    long[,] ageDayLookup = new long[9, 257];

    protected override async Task Main()
    {
        Console.WriteLine("2021 - Day 6 - Part 2", ConsoleColor.DarkMagenta);
        ...
        foreach (var counts in countsByAge)
        {
            ...
            var count = SimulateFish(counts.Key, 256);
            Console.WriteLine($"\tTotal after 256 days: {count}");
            await Task.Delay(1);
